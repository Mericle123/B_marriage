...
const UserNavbar = () => {
  return (
    <nav className="bg-pink-600 p-4 text-white shadow-md flex justify-between items-center ">
      <Link
        to="/user"
      ...
      <div className="space-x-4 flex items-center">
        ...
        <Link
          ...
          >
            Status
            <span className="absolute left-0 -bottom-1 w-0.5 bg-pink-200 transition-all duration-300 group-hover:w-full"></span>
          </Link>
        <Link
          to="/user/profile"
          className="relative group text-lg font-medium transition duration-300 hover:text-pink-200"
